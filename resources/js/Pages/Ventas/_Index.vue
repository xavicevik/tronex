                    ...
                    <section>
                        <div class="flex justify-between mx-auto p-4">
                            ...
                            <div class="pr-2 w-1/3 text-center">
                                <button @click="openModal('registrar')" class="bg-blue-500 text-xs  hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ">NUEVA VENTA</button>
                            </div>
                    ...
                    <section>
                        <div class="lg:px-4 md:px-2 sm:px-0 py-2 pb-6">
                            <table class="table-fixed w-full">
                                ...
                                <tbody>
                                <tr class="text-center" text-sm v-if="existedata > 0" v-for="(dato, id) in arrayDatos.data" :key="id">
                                    <td class="border px-1 py-2 text-sm truncate" v-text="dato.rifa.nombre"></td>
                                    <td class="border px-1 py-2 text-sm truncate" v-text="dato.serieoculta"></td>
                                    <td class="border px-1 py-2 text-sm truncate" v-text="dato.serie"></td>
                                    <td class="border px-1 py-2 text-sm truncate" v-text="dato.nombre_tecnico"></td>
                                    <td class="border px-1 py-2 text-sm truncate" v-text="formatPrice(dato.precio)"></td>
                                    <td class="border px-1 py-2 text-sm truncate" v-text="dateTime(dato.fechainicio)"></td>
                            ...
                            <pagination class="mt-6" :links="arrayDatos.links" />
                        </div>
                    </section>
    ...
    methods: {
        ...
        getRifas: async function (buscar, sortBy) {
            ...
            axios.get(url, {
                ...
                this.arrayDatos = respuesta.rifas;

                if (this.arrayDatos.data.length > 0) {
                    this.existedata = 1;
                } else {
                    this.existedata = 0;
                }
